-- Qualify the replacement predicate because the RPC also returns a column named
-- catalog_revision. This keeps the synchronization compatible with PL/pgSQL's
-- strict variable-conflict handling.
