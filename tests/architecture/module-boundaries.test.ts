...
describe("module architecture boundaries", () => {
  ...
  it("exposes standalone architecture and complete verification commands", async () => {
    ...
    expect(packageJson.scripts?.["verify:public-experience"]).toBe(
      "vitest run tests/architecture/public-experience-language-and-taxonomy.test.ts",
    );
    ...
    expect(packageJson.scripts?.["verify:production-platform"]).toBe(
      "vitest run tests/architecture/production-platform-contracts.test.ts tests/architecture/production-evidence-ledger-contract.test.ts tests/architecture/supabase-managed-backups-contract.test.ts tests/architecture/ecs-release-control-contract.test.ts tests/platform/production-evidence-ledger.test.ts tests/platform/production-manual-evidence.test.ts tests/platform/runtime-config.test.ts tests/platform/supabase-auth-protection-config.test.ts tests/platform/supabase-auth-smtp-config.test.ts tests/platform/supabase-managed-backups.test.ts tests/platform/supabase-management-migrations.test.ts tests/platform/deployment-runtime-validation.test.ts",
    );
