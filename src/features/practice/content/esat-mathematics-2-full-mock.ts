import rawPaper from "../../../../content/esat/original-practice/mathematics-2-full-mock-v1.json" with { type: "json" };
import { loadEsatOriginalMock } from "./esat-original-starter.js";

export const ESAT_MATHEMATICS_2_FULL_MOCK = loadEsatOriginalMock(rawPaper, {
