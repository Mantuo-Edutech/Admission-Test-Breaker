    ...
    <main className="account-page privacy-page">
      ...
      <section className="privacy-details page-shell">
        ...
        <article>
          ...
          <p>为了判断网站是否真的帮助学生完成路径，系统只计数：选择考试、完成档案、开始练习、完成练习、主动打开冰冰和邀请码成功。每次浏览器会话使用一个随机 Journey ID；服务器不保存账号、邮箱、IP、设备信息、课程明细、题目答案或任意文字，也不把 Journey ID 连接到 Learner Space。原始计数不向学生或公开页面开放，运营只能查看按考试和动作汇总的数量；生产数据最长保留 90 天。</p>
        </article>
        <article>
